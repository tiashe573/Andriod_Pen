...
public class MainActivity extends AppCompatActivity {
    ...
    private ImageButton color, stroke, undo, dot, erase;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // canvas=(Canvas)findViewById(R.id.draw_view);
        paint = (DrawView) findViewById(R.id.draw_view);
        paint.setBackground(getResources().getDrawable(R.drawable.tianhao));
        paint.setZ(-10);
        ...
        dot = (ImageButton) findViewById(R.id.btn_dot);
        erase = (ImageButton) findViewById(R.id.btn_erase);
